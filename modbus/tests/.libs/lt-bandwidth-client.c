...
/* ./.libs/lt-bandwidth-client.c - temporary wrapper executable for .libs/bandwidth-client
...
const char * TARGET_PROGRAM_NAME = "bandwidth-client"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bandwidth-client - temporary wrapper script for .libs/bandwidth-client\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The bandwidth-client program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"bandwidth-client:bandwidth-client:${LINENO}: libtool wrapper (GNU lib", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bandwidth-client:bandwidth-client:${LINENO}: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bandwidth-client:bandwidth-client:${LINENO}: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='bandwidth-client'\n", f);
