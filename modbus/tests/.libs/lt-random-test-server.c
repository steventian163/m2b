...
/* ./.libs/lt-random-test-server.c - temporary wrapper executable for .libs/random-test-server
   Generated by libtool (GNU libtool) 2.4.2

   The random-test-server program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "random-test-server"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# random-test-server - temporary wrapper script for .libs/random-test-server\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The random-test-server program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"random-test-server:random-test-server:${LINENO}: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"random-test-server:random-test-server:${LINENO}: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"random-test-server:random-test-server:${LINENO}: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='random-test-server'\n", f);
