...
/* ./.libs/lt-bandwidth-server-many-up.c - temporary wrapper executable for .libs/bandwidth-server-many-up
...
const char * TARGET_PROGRAM_NAME = "bandwidth-server-many-up"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bandwidth-server-many-up - temporary wrapper script for .libs/bandwidth-serve", f);
  fputs ("r-many-up\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The bandwidth-server-many-up program cannot be directly executed until all th", f);
  fputs ("e libtool\n", f);
  ...
  fputs ("    echo \"bandwidth-server-many-up:bandwidth-server-many-up:${LINENO}: libtool ", f);
  fputs ("wrapper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bandwidth-server-many-up:bandwidth-server-many-up:${LINENO}: newargv", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bandwidth-server-many-up:bandwidth-server-many-up:${LINENO}: new", f);
  ...
  fputs ("\n", f);
  fputs ("  program='bandwidth-server-many-up'\n", f);
