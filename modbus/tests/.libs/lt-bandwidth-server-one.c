...
/* ./.libs/lt-bandwidth-server-one.c - temporary wrapper executable for .libs/bandwidth-server-one
...
const char * TARGET_PROGRAM_NAME = "bandwidth-server-one"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bandwidth-server-one - temporary wrapper script for .libs/bandwidth-server-on", f);
  fputs ("e\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The bandwidth-server-one program cannot be directly executed until all the li", f);
  fputs ("btool\n", f);
  ...
  fputs ("    echo \"bandwidth-server-one:bandwidth-server-one:${LINENO}: libtool wrapper ", f);
  fputs ("(GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bandwidth-server-one:bandwidth-server-one:${LINENO}: newargv[$lt_dum", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bandwidth-server-one:bandwidth-server-one:${LINENO}: newargv[0]:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='bandwidth-server-one'\n", f);
