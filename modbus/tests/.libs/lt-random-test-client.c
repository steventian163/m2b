...
/* ./.libs/lt-random-test-client.c - temporary wrapper executable for .libs/random-test-client
   Generated by libtool (GNU libtool) 2.4.2

   The random-test-client program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/d/work_space/bacnet/modbus/libs/libmodbus/libmodbus-3.0.6/win32/src/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/d/work_space/bacnet/modbus/libs/libmodbus/libmodbus-3.0.6/win32/src/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "random-test-client"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# random-test-client - temporary wrapper script for .libs/random-test-client\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The random-test-client program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libmodbus.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"random-test-client:random-test-client:${LINENO}: libtool wrapper (GNU", f);
  fputs (" libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"random-test-client:random-test-client:${LINENO}: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"random-test-client:random-test-client:${LINENO}: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='random-test-client'\n", f);
  ...
  fputs ("    PATH=/cygdrive/d/work_space/bacnet/modbus/libs/libmodbus/libmodbus-3.0.6/wi", f);
  fputs ("n32/src/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/d/work_space/bacnet/modbus/libs/libmodbus/libmodbus-3.0.6/w", f);
  fputs ("in32/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
